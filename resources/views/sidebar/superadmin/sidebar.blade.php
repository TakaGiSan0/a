...
<aside id="sidebar"  class="z-20 w-64 h-full bg-white dark:bg-gray-800 overflow-y-auto transition-transform duration-300 ease-in-out flex inset-y-0 left-0 transform">
    <div class="py-4 text-gray-500 dark:text-gray-400 text-center">
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('matrix.index'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('matrix.index') ? 'text-gray-800 dark:text-gray-100' : 'hover:text-gray-800 dark:hover:text-gray-200' }}"
            ...
            <li class="relative px-6 py-3">
                @if (request()->routeIs('training-matrix.index'))
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                        aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('training-matrix.index') ? 'text-gray-800 dark:text-gray-100' : 'hover:text-gray-800 dark:hover:text-gray-200' }}"
                    href="{{ route('training-matrix.index') }}">
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke="none" d="M0 0h24v24H0z" />
